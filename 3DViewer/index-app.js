...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    watch: {
        ...
        level: {
            immediate: true,
            handler() {
                let allCameraInfo = [[{ id: "1-1", offsetX: 12, offsetY: 200 }, { id: "1-2", offsetX: 50, offsetY: 100 }, { id: "1-3", offsetX: 160, offsetY: 71 }], [{ id: "2-1", offsetX: 12, offsetY: 200 }, { id: "2-2", offsetX: 50, offsetY: 100 }, { id: "2-3", offsetX: 160, offsetY: 71 }, { id: "2-4", offsetX: 120, offsetY: 88 }], [{ id: "3-1", offsetX: 12, offsetY: 200 }, { id: "3-2", offsetX: 70, offsetY: 140 }, { id: "3-3", offsetX: 160, offsetY: 71 }], [{ id: "4-1", offsetX: 12, offsetY: 200 }, { id: "4-2", offsetX: 100, offsetY: 140 }, { id: "4-3", offsetX: 160, offsetY: 71 }]];
...
// module
exports.push([module.i, "\nul[data-v-3c308c68] {\n    list-style-type: none;\n    padding: 0;\n    margin:0;\n}\nli[data-v-3c308c68] {\n    display: inline-block;\n    margin: 0;\n}\n.nav-menu__item[data-v-3c308c68]{\n    background: rgba(0,84,76,0.6);\n    display:block;\n    height:35px;\n    line-height:35px;\n    margin:0;\n    padding-left:5px;\n    color: #1d1d1d;\n    cursor:pointer;\n    margin-bottom: 4px;\n}\n.nav-menu__item[data-v-3c308c68]:hover{\n    background: rgba(0,84,76,0.8);\n}\n.nav-menu__item.active[data-v-3c308c68]{\n    background: rgb(0,84,76);\n    color:#fff;\n}\n\n", "", {"version":3,"sources":["/./src/components/src/components/SideNav.vue?1e4325c2"],"names":[],"mappings":";AA4CA;IACA,sBAAA;IACA,WAAA;IACA,SAAA;CACA;AACA;IACA,sBAAA;IACA,UAAA;CACA;AACA;IACA,8BAAA;IACA,cAAA;IACA,YAAA;IACA,iBAAA;IACA,SAAA;IACA,iBAAA;IACA,eAAA;IACA,eAAA;IACA,mBAAA;CACA;AAEA;IACA,8BAAA;CACA;AACA;IACA,yBAAA;IACA,WAAA;CACA","file":"SideNav.vue","sourcesContent":["<template>\n    <div class=\"side-nav\">\n        <ul class=\"nav-menu\">\n            <li class=\"nav-menu__item\"\n                v-for=\"(item,index) of imageList\" :key=\"index\"\n                :class=\"{active: activeIndex===index}\"\n                @click=\"handleClick(item.key, index)\"\n            >\n                {{item.text}}\n            </li>\n        </ul>\n    </div>\n</template>\n\n<script>\n    export default {\n        name: 'ImageViewer',\n        data(){\n            return {\n                imageList: [\n                    {key: \"1\", text: \"第一层\"},\n                    {key: \"2\", text: \"第二层\"},\n                    {key: \"3\", text: \"第三层\"},\n                    {key: \"4\", text: \"第四层\"},\n                    {key: \"3D\", text: \"3D效果\"},\n                ],\n\n                activeIndex: 0\n            }\n        },\n        methods: {\n            handleClick(key, index){\n                this.$emit(\"nav-change\", key);\n                this.activeIndex = index;\n            }\n        },\n        props: {\n            msg: String\n        }\n    }\n</script>\n\n<!-- Add \"scoped\" attribute to limit CSS to this component only -->\n<style scoped>\n    ul {\n        list-style-type: none;\n        padding: 0;\n        margin:0;\n    }\n    li {\n        display: inline-block;\n        margin: 0;\n    }\n    .nav-menu__item{\n        background: rgba(0,84,76,0.6);\n        display:block;\n        height:35px;\n        line-height:35px;\n        margin:0;\n        padding-left:5px;\n        color: #1d1d1d;\n        cursor:pointer;\n        margin-bottom: 4px;\n    }\n\n    .nav-menu__item:hover{\n        background: rgba(0,84,76,0.8);\n    }\n    .nav-menu__item.active{\n        background: rgb(0,84,76);\n        color:#fff;\n    }\n\n</style>\n"],"sourceRoot":"webpack://"}]);
...
// module
exports.push([module.i, "\n.layout__page{\n    position: absolute;\n    left:50%;\n    top:50%;\n    width:800px;\n    height:600px;\n    border:1px solid #f2f2f2;\n    transform: translate(-50%, -50%);\n}\n.layout__image-viewer{\n    width:100%;\n    height:100%;\n    overflow:hidden;\n}\n.layout__3d-viewer{\n    width:100%;\n    height:100%;\n    overflow:hidden;\n    outline:none;\n    border:none;\n}\n.layout__side-nav{\n    position: absolute;\n    right:0;\n    top:0;\n    bottom:0;\n    width:100px;\n    background:rgba(220,220,220,0.8);\n}\n", "", {"version":3,"sources":["/./src/src/App.vue?04cb648c"],"names":[],"mappings":";AA4CA;IACA,mBAAA;IACA,SAAA;IACA,QAAA;IACA,YAAA;IACA,aAAA;IACA,yBAAA;IACA,iCAAA;CACA;AACA;IACA,WAAA;IACA,YAAA;IACA,gBAAA;CACA;AAEA;IACA,WAAA;IACA,YAAA;IACA,gBAAA;IACA,aAAA;IACA,YAAA;CACA;AACA;IACA,mBAAA;IACA,QAAA;IACA,MAAA;IACA,SAAA;IACA,YAAA;IACA,iCAAA;CACA","file":"App.vue","sourcesContent":["<template>\n    <div id=\"app\" class=\"layout__page\">\n        <image-viewer class=\"layout__image-viewer\" v-if=\"isImageViewer\" :level=\"level\"></image-viewer>\n        <iframe class=\"layout__3d-viewer\" v-else src=\"./cam/index.html\"></iframe>\n        <side-nav class=\"layout__side-nav\" @nav-change=\"handleNavChange\"></side-nav>\n    </div>\n</template>\n\n<script>\n    import SideNav from './components/SideNav.vue'\n    import ImageViewer from \"./components/ImageViewer\";\n\n    export default {\n        name: 'app',\n        components: {\n            ImageViewer,\n            SideNav\n        },\n        data(){\n            return {\n                isImageViewer: true,\n                level: 1\n            }\n        },\n        methods: {\n            handleNavChange(key){\n                console.log(key);\n                this.isImageViewer = (key !== \"3D\");\n\n                if(this.isImageViewer){\n                    this.level = (+key);\n                }\n            }\n        }\n    }\n</script>\n\n<style>\n    html,body{\n        margin:0;\n        padding:0;\n    }\n</style>\n<style>\n    .layout__page{\n        position: absolute;\n        left:50%;\n        top:50%;\n        width:800px;\n        height:600px;\n        border:1px solid #f2f2f2;\n        transform: translate(-50%, -50%);\n    }\n    .layout__image-viewer{\n        width:100%;\n        height:100%;\n        overflow:hidden;\n    }\n\n    .layout__3d-viewer{\n        width:100%;\n        height:100%;\n        overflow:hidden;\n        outline:none;\n        border:none;\n    }\n    .layout__side-nav{\n        position: absolute;\n        right:0;\n        top:0;\n        bottom:0;\n        width:100px;\n        background:rgba(220,220,220,0.8);\n    }\n</style>\n"],"sourceRoot":"webpack://"}]);
        ...
        [
          ...
          _vm._l(_vm.cameraInfo, function(camera, index) {
            return _c(
              ...
              [_vm._v("camera-" + _vm._s(camera.id))]
            )
          })
        ],
        2
